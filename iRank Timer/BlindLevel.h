...
@interface BlindLevel : NSObject <NSCoding, NSCopying> {
    
}

@property (nonatomic, readwrite) int levelIndex;
...
-(id)initWithLevelNumber:(int)levelNumber levelIndex:(int)pLevelIndex smallBlind:(int)smallBlind bigBlind:(int)bigBlind ante:(int)ante duration:(int)duration;
-(id)initWithDuration:(int)duration isBreak:(int)isBreak levelIndex:(int)pLevelIndex;
