...
-(void)localizeView{
    ...
    lblIntro.text = NSLocalizedString(@"intro", "WizardViewController");
...
//        if( players > 6 && ((switchAllowAddon.on==YES && level==7) || level==15) ){
        if( (switchAllowAddon.on==YES && level==7) ||
           ...
           (players > 7 && level==15) ){
            ...
            blindLevel = [[BlindLevel alloc] initWithLevelNumber:levelNumber smallBlind:smallBlind bigBlind:bigBlind ante:ante duration:blindDuration];
