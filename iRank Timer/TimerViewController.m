...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if( tableView.tag==0 ){
        ...
        if( appDelegate.isIOS7 ){
            ...
            [bgColorView setBackgroundColor:[UIColor darkTextColor]];
    ...
    if( levelNumber==blindSet.currentLevel ){
        ...
        cell.lblLevel.textColor      = [UIColor whiteColor];
        cell.lblSmallBlind.textColor = [UIColor whiteColor];
        cell.lblBigBlind.textColor   = [UIColor whiteColor];
        cell.lblAnte.textColor       = [UIColor whiteColor];
        cell.lblDuration.textColor   = [UIColor whiteColor];
        cell.lblElapsed.textColor    = [UIColor whiteColor];
        
        cell.contentView.backgroundColor = [UIColor darkRedColor];
    }else{
        ...
        cell.lblSmallBlind.textColor = [UIColor grayColor];
        cell.lblBigBlind.textColor   = [UIColor grayColor];
        cell.lblAnte.textColor       = [UIColor grayColor];
        cell.lblDuration.textColor   = [UIColor grayColor];
        cell.lblElapsed.textColor    = [UIColor grayColor];
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if( editingStyle == UITableViewCellEditingStyleDelete ){
        ...
        if( indexPath.row >= appDelegate.blindSetList.count )
            indexPath = [NSIndexPath indexPathForRow:(appDelegate.blindSetList.count-1) inSection:0];
...
-(void)updateTimerColor {
    ...
    if( timerSlider.value < 10 ){
        ...
        lblTimer.textColor    = [UIColor darkRed2Color];
        lblTimer.shadowColor  = [UIColor darkRedColor];
        lblTimer.shadowOffset = CGSizeMake(1, 2);
        
        if( [backgroundColor isEqualToString:@"blue"] ){

            backgroundColor = @"red";
            imgMainBg.image = [UIImage imageNamed:@"timer-red-bg"];
        }
    }else{
        
        lblTimer.textColor    = [UIColor whiteColor];
        lblTimer.shadowColor  = [UIColor blackColor];
        lblTimer.shadowOffset = CGSizeMake(0, 4);
        
        if( [backgroundColor isEqualToString:@"red"] ){
            
            backgroundColor = @"blue";
            imgMainBg.image = [UIImage imageNamed:@"timer-blue-bg"];
        }
    }
}
