...
//    NSLog(@"elementName: %@", elementName);
    ...
    if( [elementName isEqualToString:@"blindLevel"] ){
        ...
        if( isBreak ){
            ...
            blindLevel = [[BlindLevel alloc] initWithLevelNumber:levelNumber levelIndex:blindSet.blindLevels smallBlind:smallBlind bigBlind:bigBlind ante:ante duration:duration];
        }
...
//    NSLog(@"didEndElement");
    ...
    if( [elementName isEqualToString:@"blindSet"] ){
        ...
        [blindSet setBlindSetIndex: [blindSetList count]];
