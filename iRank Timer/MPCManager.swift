...
class MPCManager: NSObject, MCSessionDelegate, MCNearbyServiceBrowserDelegate, MCNearbyServiceAdvertiserDelegate {
    ...
    override init() {
        ...
        browser = MCNearbyServiceBrowser(peer: peer, serviceType: "iranktimer-mpc")
        browser.delegate = self
        
        advertiser = MCNearbyServiceAdvertiser(peer: peer, discoveryInfo: nil, serviceType: "iranktimer-mpc")
